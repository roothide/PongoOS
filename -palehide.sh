...
~/Documents/iostools/palera1n-macos-universal -l $1 -k "$basepath"/build/Pongo.bin -K "$basepath"/build/checkra1n-kpf-pongo -o "$basepath"/../palehide-jbinit/.theos/_/usr/local/bin/jbinit
